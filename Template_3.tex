...
Wir bestimmen $U_\text{thr}$ zu \SI{1.4}{\volt}. Im Vergleich zu der Messung der
Schwellenspannung, die wir auf Seite~\pageref{par:Schwellenspannung} gemessen
haben, $\messwert$.

\TODO{
	Mit Schwellenspannung auf Seite~\pageref{par:Schwellenspannung}
	vergleichen.
}
...
\begin{table}[htbp]
	\centering
	\begin{tabular}{SSSS}
		{Kapazität / \si{\farad}} & {Oszilloskop alleine / \si\second} & {Bipoltransistor / \si\second} & {FET \/
		\si\second} \\
		\hline
		1e-6 & .64 & 76 & .63 \\
		10e-9 & 7.5e-3 & .8 & 10e-3 \\
		100e-12 & 1e-3 & 20e-3 & .5e-3
	\end{tabular}
	\caption{
