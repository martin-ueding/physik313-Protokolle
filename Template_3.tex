...
\TODO{Bild einscannen und Gerade einzeichnen}
...
\FRAGE{
	Wie soll die Abhängigkeit des $\ID$ gegen $\UGS$ aus dem Feld extrahiert
	werden? Das Feld ist diese Abhängigkeit. Sollen wir daraus einige Punkte
	ablesen, damit wir plotten können? Sollen wir dann mit den diskretisierten
	Punkten plotten und fitten?
}
