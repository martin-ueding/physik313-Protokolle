...
\begin{figure}[htbp]
	\centering
	%\includegraphics[width=.4\linewidth]{Anleitung/5_6-8.png}
	\caption{%
		\cite[Abbildung~5/6.8]{physik313-Anleitung}
	}
	\label{fig:5_6-8}
\end{figure}

Da die Kennlinie einer Diode in weiten Bereichen durch die Exponentialfunktion
\[
    \ID = I_0\exp{\alpha\UD}
\]
beschrieben werden kann. Erhält man aus der Schaltung in
Abbildung~\ref{fig:5_6-8} die Ausgangsspannung
\[
    \Uout = A \log{B\Uin}
\]
...
\begin{figure}[htbp]
	\centering
	%\includegraphics[width=.4\linewidth]{Anleitung/5_6-9.png}
	\caption{%
		\cite[Abbildung~5/6.9]{physik313-Anleitung}
	}
	\label{fig:5_6-9}
\end{figure}

Mit der Gleichen Argumentation, wie beim Logarithmierer, erhält man aus der
Schaltung in Abbildung~\ref{fig:5_6-9} die Ausgangsspannung
\[
    \Uout = -RI_0\exp{\alpha\Uin}
\]
