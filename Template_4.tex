...
danach umgekehrt. Die Messung ist in Tabelle~\ref{tab:4-1-1}.
...
\]
unabhängig sein soll von $\RE$ und $\RC$ wurde nicht bestätigt. Die Werte von
$v$ schwanken schon deutlich. Bei sehr kleinem $\RE$ wurde die Verstärkung
groß, während bei sehr großem $\RC$ die Verstärkung kleiner wurde.
...
und $\RE$, siehe Tabelle~\ref{tab:412}.
...
\begin{figure}[htbp]
	...
	\caption{%
		Erstes Diagramm zur Auswertung. Dabei sind in rot die ersten Einträge
		aus Tabelle~\ref{tab:412}, Letzten in blau.
	}
	\label{fig:}
\end{figure}
