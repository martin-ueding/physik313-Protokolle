...
Alles dies ist jedenfalls sehr merkwürdig. Damit die Auswertung trotzdem
klappt, haben wir die Verstärkung mit einem Faktor 100 multipliziert, damit sie
bei einem Faktor 10 anfängt.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{4-1-4-Plot.pdf}
    \caption{%
        Bode-Plot für die Verstärkerschaltungen.
    }
    \label{fig:414plot}
\end{figure}

Aus diesem Plot lesen wir eine Bandbreite von \SI{1.e6}{\hertz} und
\SI{1.2e6}{\hertz} für den Verstärker ohne bzw. mit Kaskode ab. Die
Transitfrequenz ist \SI{1.1e6}{\hertz} bzw. \SI{1.2e7}{\hertz}.
