...
Leitfähigkeit zu verbessern. In Halbleitern wäre
...
Betrachtet man für die ideale Spannungsquelle den Grenzwert $R_\text{I}\to0$ geht die Steigung in \ref{fig:F-Spannungsquelle} gegen unendlich und wir erhalten eine Senkrechte.
...
$\RL = 0$, sowie $I_\text{min} = 0$ und $U' = U_0$ wenn $\RL \to \infty$.
