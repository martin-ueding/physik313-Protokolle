...
\begin{problem}
	...
	Abbildung~2.3 ($R = \SI{100}\ohm$, D = Diode). Erläutern Sie bei c) und d)
	den Einfluss der Widerstände.
\end{problem}
...
\begin{problem}
	...
	Schaltungen in Abbildung~2.4~(a) und (b), wenn die Eingangsspannung eine
