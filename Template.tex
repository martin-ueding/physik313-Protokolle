...
Der Potenzialverlauf ist in Abb.~\ref{fig:B_Zeichnung} zu sehen. Dabei ist der Verlauf bei angelegter Spannung durchgezogen.

\begin{figure}
	\centering
	\includegraphics[width=.6\textwidth]{Zeichnungen/B_Zeichnung.pdf}
	\caption{%
...
Die Ladungsträgerkonzentration im npn-Transistor ist in Abb.~\ref{fig:C_Zeichnung} zu sehen.

\begin{figure}
	\centering
	\includegraphics[width=.6\textwidth]{Zeichnungen/C_Zeichnung.pdf}
	\caption{%
