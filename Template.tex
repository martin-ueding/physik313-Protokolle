...
\begin{figure}
	...
	\end{minipage}
	\caption{%
		Rechteck, Frequenz \SI{200}{\kilo\hertz}, Zeitbasis \SI{1}{\milli\second\per\division}, Verstärkung \SI{5}{\volt\per\division}, externe Triggerung
	}
	\label{fig:0752}
\end{figure}
...
Durch den zusätzlichen Widerstand wird das Signal gedämpft.
...
\begin{figure}
	...
	\end{minipage}
	\caption{%
		Rechteck, Frequenz \SI{200}{\kilo\hertz}, Zeitbasis \SI{1}{\milli\second\per\division}, Verstärkung \SI{20}{\volt\per\division}, externe Triggerung
	}
	\label{fig:0755}
\end{figure}
