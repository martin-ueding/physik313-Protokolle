...
ab. Eine Skizze zu diesem Aufbau ist in Abbildung~\ref{fig:2-10}. Das Netzteil versorgt die Schaltung mit \SI{20}{\volt} bei \SI{50}{\hertz}.
...
Das Oszillogramm der gleichgerichteten Spannung ist in Abbildung~\ref{fig:790}.
...
Mit einer zusätzlichen, parallelen Kapazität von \SI{2.2}{\micro\farad} wird die Spannung etwas geglättet, siehe Abbildung \ref{fig:792}. Dabei ist die exponentielle Entladung des Kondensator zu beobachten.
...
Bei \SI{24.2}{\micro\farad} ist der Brumm deutlich kleiner geworden, der Kondensator kann nicht mehr komplett entladen werden, da seine Kapazität zu groß ist. Dies ist in Abbildung~\ref{fig:793} gezeigt.
...
Mit \SI{1022}{\micro\farad} ist mit dem Auge kein Brumm mehr zu erkennen, siehe Abbildung \ref{fig:795}.
...
Abbildungen~\ref{fig:796} für \SI{0}{\micro\farad}, Abbildungen~\ref{fig:797}
für \SI{2.2}{\micro\farad}, Abbildungen~\ref{fig:798} für
\SI{24.2}{\micro\farad}. Bei der größten Kapazität sieht das Oszillogramm
genauso aus, wie das in Abbildung~\ref{fig:795}.
