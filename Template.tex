...
\begin{figure}
	...
	\hfill
	\begin{minipage}{.45\linewidth}
	\includegraphics[width=\linewidth]{Fotos/IMG_0760-1500.jpg}
	\end{minipage}
	\caption{%
		Rechteck, Frequenz \SI{200}{\kilo\hertz},
		Zeitbasis \SI{.5}{\micro\second\per\division},
		Verstärkung \SI{200}{\milli\volt\per\division},
		externe Triggerung
	}
	\label{fig:0760}
\end{figure}
...
\begin{figure}
	...
	\hfill
	\begin{minipage}{.45\linewidth}
	\includegraphics[width=\linewidth]{Fotos/IMG_0761-1500.jpg}
	\end{minipage}
	\caption{%
		Rechteck, Frequenz \SI{200}{\kilo\hertz},
		Zeitbasis \SI{.5}{\micro\second\per\division},
...
\begin{figure}
	...
	\hfill
	\begin{minipage}{.45\linewidth}
	\includegraphics[width=\linewidth]{Fotos/IMG_0762-1500.jpg}
	\end{minipage}
	\caption{%
		Rechteck, Frequenz \SI{200}{\kilo\hertz},
