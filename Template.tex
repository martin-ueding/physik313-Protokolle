...
koppeln wir mit dem \SI{2450}{\ohm} Widerstand in das Verzögerungskabel HH
2500. Dieses Kabel wird aufgrund seiner Wirkung auch \emph{Klippkabel} genannt.
Außerdem nehmen wir am Anfang des Verzögerungskabels mit dem Oszilloskop das
Signal ab. Wir benutzen die externe Triggerung. Ans Ende des Verzögerungskabels
werden wir verschiedene Abschlusswiderstände montieren. Der Aufbau ist in
Abbildung \ref{fig:1-9} abgebildet.
...
\emph{subtrahiert}. Dadurch wird der Impuls geklippt. Auch hier ist durch
Dämpfung die Interferenz nicht perfekt.
