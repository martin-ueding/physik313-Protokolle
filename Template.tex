...
haben wir den Frequenzbereich entnommen, dieser wird mit $\SI{<< B >>}\hertz$
angegeben. Daraus folgt nach der Formal (0.4) aus der Anleitung für die
Anstiegszeit: $\Deltaup t = \SI{<< Delta_t >>}\second$.
