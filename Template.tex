...
Mit unserer gemessenen Anstiegszeit von $\Deltaup t_\text{gemessen} = \SI{<< Delta_t_gemessen_val >> +- << Delta_t_gemessen_err >>}\second$ können wir die des Signalgenerators errechnen:
\[
	\Deltaup t_\text{Signal}
	= \sqrt{\Deltaup t_\text{Signal} - \Deltaup t_\text{Signal}}
	= \SI{<< Delta_t_Signal_val >> +- << Delta_t_Signal_err >>}\second
\]
